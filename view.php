...
<div class="container">
  <?php
    ...
    switch ($status) {
      case 'success':
        echo "<div class='alert alert-success text-center mt-3'>✅ <b>$bar</b> Request submitted successfully.</div>";
        break;
      case 'duplicate':
        echo "<div class='alert alert-warning text-center mt-3'>⚠️ <b>$bar</b> already requested.</div>";
        break;
      case 'fail':
        echo "<div class='alert alert-danger text-center mt-3'>❌ <b>$bar</b> Failed to submit request. Try again later.</div>";
        break;
      case 'not_found':
        echo "<div class='alert alert-danger text-center mt-3'>🚫 <b>$bar</b> not found in inventory.</div>";
        break;
...
<?php if ($result && mysqli_num_rows($result) > 0): ?>
  <table class="table table-bordered info-table">
    <thead>
      <tr><th colspan="2" class="text-center">📦 Item Information</th></tr>
    </thead>
    <tbody>
